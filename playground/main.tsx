...
const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    label: "Winamp",
    vars: {
      "--mdw-toolbar-gradient-from": "#4a4a4a",
      "--mdw-toolbar-gradient-via": "#2a2a2a",
      "--mdw-toolbar-gradient-to": "#1a1a1a",
      "--mdw-toolbar-fg": "#00ff00",
      "--mdw-toolbar-font-family": '"Courier New", ui-monospace, monospace',
      "--mdw-toolbar-select-bg": "#232323",
      "--mdw-button-active-bg": "#5a7a9a",
      "--mdw-button-hover-gradient-from": "#6a6a6a",
      "--mdw-button-hover-gradient-to": "#3a3a3a",
      "--mdw-content-bg": "#232323",
      "--mdw-content-wysiwyg-fg": "#00ff00",
      "--mdw-content-wysiwyg-font-family": '"Courier New", ui-monospace, monospace',
      "--mdw-content-markdown-fg": "#00ff00",
      "--mdw-content-markdown-font-family": "ui-monospace, Consolas, monospace",
      "--mdw-scrollbar-thumb": "#5a7a9a",
      "--mdw-scrollbar-track": "#1a1a1a",
      "--mdw-table-header-bg": "#3a3a3a",
      "--mdw-code-block-bg": "#1a1a1a",
      "--mdw-mermaid-bg": "#1a1a1a",
    },
  },
  {
    id: "cg",
