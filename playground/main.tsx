...
const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    label: "CG Theme",
    vars: {
      "--mdw-toolbar-gradient-from": "#ffffff",
      "--mdw-toolbar-gradient-via": "#f5f5f5",
      "--mdw-toolbar-gradient-to": "#e3f2fd",
      "--mdw-toolbar-fg": "#032038",
      "--mdw-toolbar-font-family": '"Montserrat", sans-serif',
      "--mdw-toolbar-select-bg": "#e3f2fd",
      "--mdw-button-active-bg": "#0069a7",
      "--mdw-button-hover-gradient-from": "#e3f2fd",
      "--mdw-button-hover-gradient-to": "#0069a733",
      "--mdw-content-bg": "#ffffff",
      "--mdw-content-wysiwyg-fg": "#032038",
      "--mdw-content-wysiwyg-font-family": '"Montserrat", sans-serif',
      "--mdw-content-markdown-fg": "#032038",
      "--mdw-content-markdown-font-family": "ui-monospace, Consolas, monospace",
      "--mdw-scrollbar-thumb": "#0069a7",
      "--mdw-scrollbar-track": "#e3f2fd",
      "--mdw-table-header-bg": "#e3f2fd",
      "--mdw-code-block-bg": "#e3f2fd",
      "--mdw-mermaid-bg": "#e3f2fd",
    },
  },
];
